...
from instance_api import VALID_SIZES, canonicalize_instance_api_name
...
FAMILY_UPGRADE_MAP: dict[str, tuple[str, str]] = {'t2': ('t3', 't4g'), 't3': ('t3a', 't4g'), 't3a': ('t4g', 't4g'), 't4g': ('t4g', 't4g'), 'm1': ('m4', 'm7g'), 'm2': ('m4', 'm7g'), 'm3': ('m4', 'm6g'), 'm4': ('m5', 'm6g'), 'm5': ('m6i', 'm7g'), 'm5a': ('m6i', 'm7g'), 'm5n': ('m6i', 'm7i'), 'm5zn': ('m6i', 'm7i'), 'm6i': ('m7i', 'm7g'), 'm6g': ('m7g', 'm7g'), 'm6a': ('m7i', 'm7g'), 'm7i': ('m7i', 'm7g'), 'm7g': ('m7g', 'm7g'), 'c1': ('c4', 'c7g'), 'c3': ('c4', 'c7g'), 'c4': ('c5', 'c6g'), 'c5': ('c6i', 'c7g'), 'c5a': ('c6i', 'c7g'), 'c6i': ('c7i', 'c7g'), 'c6g': ('c7g', 'c7g'), 'c6a': ('c7i', 'c7g'), 'c7i': ('c7i', 'c7g'), 'c7g': ('c7g', 'c7g'), 'r3': ('r4', 'r7g'), 'r4': ('r5', 'r6g'), 'r5': ('r6i', 'r7g'), 'r5a': ('r6i', 'r7g'), 'r5b': ('r6i', 'r7i'), 'r6i': ('r7i', 'r7g'), 'r6g': ('r7g', 'r7g'), 'r6a': ('r7i', 'r7g'), 'r7i': ('r7i', 'r7g'), 'r7g': ('r7g', 'r7g'), 'x1': ('x2idn', 'x2iedn'), 'x1e': ('x2idn', 'x2iedn'), 'x2idn': ('x2iedn', 'x2iedn'), 'i2': ('i3', 'i4i'), 'i3': ('i3en', 'i4i'), 'i3en': ('i4i', 'i4i'), 'i4i': ('i4i', 'i4i'), 'd2': ('d3', 'd3'), 'd3': ('d3', 'd3'), 'h1': ('i3en', 'i4i'), 'p2': ('p3', 'p4d'), 'p3': ('p4d', 'p4d'), 'p4d': ('p4d', 'p4d'), 'g3': ('g4dn', 'g5'), 'g4dn': ('g5', 'g5'), 'g4ad': ('g5', 'g5'), 'g5': ('g5', 'g5'), 'inf1': ('inf2', 'inf2'), 'inf2': ('inf2', 'inf2'), 'trn1': ('trn1', 'trn1'), 'c5n': ('c6in', 'c7gn'), 'c6in': ('c7i', 'c7gn'), 'c7gn': ('c7gn', 'c7gn'), 'r5n': ('r6in', 'r6in'), 'r6in': ('r7i', 'r7i')}
INTEL_UPGRADE_MAP: dict[str, tuple[str, str]] = {'t2': ('t3', 't3a'), 't3': ('t3a', 't3a'), 't3a': ('t3a', 't3a'), 'm1': ('m4', 'm7i'), 'm2': ('m4', 'm7i'), 'm3': ('m4', 'm6i'), 'm4': ('m5', 'm7i'), 'm5': ('m6i', 'm7i'), 'm5a': ('m6i', 'm7i'), 'm5n': ('m6i', 'm7i'), 'm5zn': ('m6i', 'm7i'), 'm6i': ('m7i', 'm7i'), 'm6a': ('m7i', 'm7i'), 'm6g': ('m7i', 'm7i'), 'm7i': ('m7i', 'm7i'), 'm7g': ('m7i', 'm7i'), 'c1': ('c4', 'c7i'), 'c3': ('c4', 'c7i'), 'c4': ('c5', 'c7i'), 'c5': ('c6i', 'c7i'), 'c5a': ('c6i', 'c7i'), 'c5n': ('c6in', 'c7i'), 'c6i': ('c7i', 'c7i'), 'c6a': ('c7i', 'c7i'), 'c6g': ('c7i', 'c7i'), 'c7i': ('c7i', 'c7i'), 'c7g': ('c7i', 'c7i'), 'r3': ('r4', 'r7i'), 'r4': ('r5', 'r7i'), 'r5': ('r6i', 'r7i'), 'r5a': ('r6i', 'r7i'), 'r5b': ('r6i', 'r7i'), 'r5n': ('r6in', 'r7i'), 'r6i': ('r7i', 'r7i'), 'r6a': ('r7i', 'r7i'), 'r6g': ('r7i', 'r7i'), 'r7i': ('r7i', 'r7i'), 'r7g': ('r7i', 'r7i'), 'x1': ('x2idn', 'x2iedn'), 'x1e': ('x2idn', 'x2iedn'), 'x2idn': ('x2iedn', 'x2iedn'), 'i2': ('i3', 'i4i'), 'i3': ('i3en', 'i4i'), 'i3en': ('i4i', 'i4i'), 'i4i': ('i4i', 'i4i'), 'd2': ('d3', 'd3'), 'd3': ('d3', 'd3'), 'h1': ('i3en', 'i4i'), 'p2': ('p3', 'p4d'), 'p3': ('p4d', 'p4d'), 'p4d': ('p4d', 'p4d'), 'g3': ('g4dn', 'g5'), 'g4dn': ('g5', 'g5'), 'g4ad': ('g5', 'g5'), 'g5': ('g5', 'g5'), 'inf1': ('inf2', 'inf2'), 'inf2': ('inf2', 'inf2'), 'trn1': ('trn1', 'trn1'), 'c6in': ('c7i', 'c7gn'), 'c7gn': ('c7gn', 'c7gn')}
GRAV_UPGRADE_MAP: dict[str, tuple[str, str]] = {'t2': ('t3a', 't4g'), 't3': ('t4g', 't4g'), 't3a': ('t4g', 't4g'), 't4g': ('t4g', 't4g'), 'm1': ('m4', 'm7g'), 'm2': ('m4', 'm7g'), 'm3': ('m4', 'm6g'), 'm4': ('m5', 'm7g'), 'm5': ('m6g', 'm7g'), 'm5a': ('m6g', 'm7g'), 'm5n': ('m6g', 'm7g'), 'm5zn': ('m6g', 'm7g'), 'm6i': ('m6g', 'm7g'), 'm6g': ('m7g', 'm7g'), 'm6a': ('m6g', 'm7g'), 'm7i': ('m7g', 'm7g'), 'm7g': ('m7g', 'm7g'), 'c1': ('c4', 'c7g'), 'c3': ('c4', 'c7g'), 'c4': ('c5', 'c7g'), 'c5': ('c6g', 'c7g'), 'c5a': ('c6g', 'c7g'), 'c5n': ('c6g', 'c7gn'), 'c6i': ('c6g', 'c7g'), 'c6g': ('c7g', 'c7g'), 'c6a': ('c6g', 'c7g'), 'c7i': ('c7g', 'c7g'), 'c7g': ('c7g', 'c7g'), 'r3': ('r4', 'r7g'), 'r4': ('r5', 'r7g'), 'r5': ('r6g', 'r7g'), 'r5a': ('r6g', 'r7g'), 'r5b': ('r6g', 'r7g'), 'r5n': ('r6g', 'r7g'), 'r6i': ('r6g', 'r7g'), 'r6g': ('r7g', 'r7g'), 'r6a': ('r6g', 'r7g'), 'r7i': ('r7g', 'r7g'), 'r7g': ('r7g', 'r7g'), 'x1': ('x2idn', 'x2iedn'), 'x1e': ('x2idn', 'x2iedn'), 'x2idn': ('x2iedn', 'x2iedn'), 'i2': ('i3', 'i4i'), 'i3': ('i3en', 'i4i'), 'i3en': ('i4i', 'i4i'), 'i4i': ('i4i', 'i4i'), 'd2': ('d3', 'd3'), 'd3': ('d3', 'd3'), 'h1': ('i3en', 'i4i'), 'p2': ('p3', 'p4d'), 'p3': ('p4d', 'p4d'), 'p4d': ('p4d', 'p4d'), 'g3': ('g4dn', 'g5'), 'g4dn': ('g5', 'g5'), 'g4ad': ('g5', 'g5'), 'g5': ('g5', 'g5'), 'inf1': ('inf2', 'inf2'), 'inf2': ('inf2', 'inf2'), 'trn1': ('trn1', 'trn1'), 'c6in': ('c7gn', 'c7gn'), 'c7gn': ('c7gn', 'c7gn')}
...
def _lookup_upgrade(family: str, mode: CPUFilterMode) -> tuple[str, str] | None:
    if mode == 'both':
        return FAMILY_UPGRADE_MAP.get(family)
    if mode == 'intel':
        return INTEL_UPGRADE_MAP.get(family)
    if mode == 'graviton':
        return GRAV_UPGRADE_MAP.get(family)
...
def get_recommendations(instance_type: str, cpu_filter: CPUFilterMode='both') -> dict[str, str | None]:
    ...
    if canon is None or canon.startswith('db.'):
        if instance_type and str(instance_type).strip():
            logger.warning('Invalid or non-EC2 API Name (value omitted for security)')
        return result
    parsed = parse_instance(canon)
    if parsed is None:
